...
async function generateAdCopy(ad) {
  ...
  const systemPrompt = [
    ...
    '',
    'STRONG (match this REGISTER — never reuse these words, they are about a',
    'different subject on purpose):',
    '  headline: "You can quote the verse and still not know the Author."',
    '  subhead:  "Familiarity is not the same as relationship."',
    '  hook:     "Most people learn about God the way they learn about weather."',
    'Why it works: names a real condition, no hype, and the offer is a fact rather than a promise.',
    'Write something entirely your own for the page above. Do not echo the example.',
    '',
